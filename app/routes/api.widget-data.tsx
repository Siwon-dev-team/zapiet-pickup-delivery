  ...
  const rates = await db.rate.findMany({
    ...
    return json({
      settings: {
          ...
          enableOrderNote: (s?.enablePickupNote ?? true) || (s?.enableDeliveryNote ?? true),
          ...
          enablePickupNextWeekOnly: s?.enablePickupNextWeekOnly ?? false,
          pickupNextWeekSameWeekDays: s?.pickupNextWeekSameWeekDays ?? "[]",
